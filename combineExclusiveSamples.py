...
#             oName = iFile[:iFile.find("-50")] + '-50to200' + iFile[iFile.find("-50")+3:]
            oName = iFile[:iFile.find("-2000")] + '-2800to3000' + iFile[iFile.find("3000")+4:]
...
process = ['WJets_LO']#, 'WJets_LO']#'DY-50']#, 'DY-50_LO']#]
process = ['DY-2000to3000']#, 'WJets_LO']#'DY-50']#, 'DY-50_LO']#]

FS = ['et', 'em']#, 'et', 'tt', 'mt']
binned = ['']#, '_HT-100to200', '_HT-200to400', '_HT-600toInf']#'_HT-400to600',
tail = 'noIso'
location = '/nfs_scratch/zmao/singalRegion_pdf/'
