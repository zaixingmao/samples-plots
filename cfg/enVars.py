...
#                     ("DY-10to50",     "%s/DYJetsToLL_M-10to50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 18610),
                     ("data_tt",     "/hdfs/store/user/zmao/data_25ns_Spring15_eletronID2/data_Tau_Run2015C_PromptReco_25ns", 1, 'tt'),
                     ("data_em",     "/hdfs/store/user/zmao/data_25ns_Spring15_eletronID2/data_MuonEG_Run2015C_PromptReco_25ns", 1, 'em'),
                   ("data_mt",     "/hdfs/store/user/zmao/data_25ns_Spring15_eletronID2/data_Muon_Run2015C_PromptReco_25ns", 1, 'mt'),
                    ("data_et",     "/hdfs/store/user/zmao/data_25ns_Spring15_eletronID2/data_Electron_Run2015C_PromptReco_25ns", 1, 'et'),
