...
preFix2 = '/store/user/zmao/Apr15/'

type = '0BTag'     #selection type (baseline, inclusive)
...
#                     ("data_MuonEGv4",     "%s/data_MuonEG_Run2015DV4_PromptReco_25ns" %preFix, 1, 'em'),
                    ("data_Electron",     "%s/data_Electron_Run2015D-16Dec" %preFix, 1, fs),
...
# 
                    ...
                    ("DY-100to200",     "%s/DYJetsToLL_M-100to200_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 226*K_DY_mass, fs),
                    ("DY-200to400",     "%s/DYJetsToLL_M-200to400_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 7.67*K_DY_mass, fs),
                    ("DY-400to500",     "%s/DYJetsToLL_M-400to500_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 0.423*K_DY_mass, fs),
                    ("DY-500to700",     "%s/DYJetsToLL_M-500to700_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 0.24*K_DY_mass, fs),
                    ("DY-700to800",     "%s/DYJetsToLL_M-700to800_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 0.035*K_DY_mass, fs),
                    ("DY-800to1000",     "%s/DYJetsToLL_M-800to1000_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 0.03*K_DY_mass, fs),
                    ("DY-1000to1500",     "%s/DYJetsToLL_M-1000to1500_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 0.016*K_DY_mass, fs),
                    ("DY-1500to2000",     "%s/DYJetsToLL_M-1500to2000_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 0.002*K_DY_mass, fs),
#                     ("DY-2000to3000",     "%s/DYJetsToLL_M-2000to3000_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8" %(preFix), 0.0005*K_DY_mass, fs),
