...
#             if (tree.tByCombinedIsolationDeltaBetaCorrRaw3Hits < 0.1) and (tree.eRelIso < 0.15) and region == 'signal':
                return True
...
#     histDict['ZPrime_500'].Scale(1, option)
...
#                     histDict['ZPrime_500'].Scale(1000)
