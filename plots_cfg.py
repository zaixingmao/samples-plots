...
dir = "/user_data/zmao/noIso/"
dir_data = "/user_data/zmao/RunD_594/"
sampleList = [
...
vars = [# ("ePt", array('d', range(0,120,15)), 'GeV', 0.25),
#         ("mPt", array('d', range(0,120,15)), 'GeV', 0.25),
#       ("tPt", array('d', range(0, 200, 10)), 'GeV', 0.25),
...
#         ("m_vis", array('d', range(0, 200, 15)), 'GeV', 0.25),
...
#        ("pZeta - 3.1pZetaVis", array('d', range(-200, 100, 10)), '', 0.25),
